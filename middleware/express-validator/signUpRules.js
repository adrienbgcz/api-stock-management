...
export default {
    validationRules() {
        return [
            body("pseudo")
                .exists().withMessage("Pseudo is empty")
                .isLength({min: 2, max: 65}).withMessage("Pseudo must contain between 2 and 20 characters")
                .matches(/^[a-zA-Z0-9éèàêïî ]{2,20}$/).withMessage("Invalid pseudo format"),
            body("email")
